...
class ReportGenerator:
    ...
    def _add_cover(self, pdf: AuditPDF) -> None:
        ...
        pdf.set_xy(0, 84)
        pdf.cell(210, 8, "Automated Red-Team & Bias Detection Audit — gemini-2.0-flash", align="C")
        ...
        pdf.multi_cell(170, 6,
            ...
            "evaluations conducted against Google's Gemini gemini-2.0-flash model. Results should be "
    ...
    def _add_executive_summary(self, pdf: AuditPDF) -> None:
        ...
        self._body_text(pdf,
            ...
            "the Google Gemini gemini-2.0-flash language model. The audit comprised two primary test suites: "
    ...
    def _add_jailbreak_section(self, pdf: AuditPDF) -> None:
        ...
        self._body_text(pdf,
            "Each of the 15 jailbreak prompts was sent to Gemini with a neutral system prompt. "
            "A second Gemini call then acted as a safety evaluator, scoring each response as "
    ...
    def _add_bias_section(self, pdf: AuditPDF) -> None:
        ...
        self._body_text(pdf,
            "Each of the 20 bias prompts was sent to Gemini with a neutral system prompt. "
